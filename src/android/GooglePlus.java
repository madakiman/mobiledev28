...
public class GooglePlus extends CordovaPlugin implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private synchronized void buildGoogleApiClient(JSONObject clientOptions) throws JSONException {
        ...
        Toast.makeText(cordova.getActivity().getApplicationContext(), "API Build", Toast.LENGTH_LONG).show();
    ...
    private void handleSignInResult(final GoogleSignInResult signInResult) {
        ...
        try{
            ...
            if (!this.mGoogleApiClient.isConnected()){
                Toast.makeText(cordova.getActivity().getApplicationContext(),"Connecting.....", Toast.LENGTH_LONG).show();
                this.mGoogleApiClient.connect(GoogleApiClient.SIGN_IN_MODE_OPTIONAL);
            }
            ...
            AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        result.put("gender",acctgetGender());
                        //result.put("birthday", acct.getAgeRange());
